...
class EditarDocumentoScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<EditarDocumentoScreen> createState() =>
      _EditarDocumentoScreenState();
}

class _EditarDocumentoScreenState extends ConsumerState<EditarDocumentoScreen> {
  ...
  late DocumentoTipo _tipoSeleccionado;

  @override
  void initState() {
    super.initState();
    _fechaSeleccionada = widget.documento.fecha;
    _tipoSeleccionado = widget.documento.tipo;
    _tituloController.text = widget.documento.titulo;
    _nombreArchivoController.text = widget.documento.nombreArchivo;
    _rutaArchivoController.text = widget.documento.rutaArchivo;
    _mimeTypeController.text = widget.documento.mimeType ?? '';
    _tamanoBytesController.text = widget.documento.tamanoBytes.toString();
  ...
  Future<void> _guardarDocumento() async {
    ...
    await repository.actualizarDocumento(
      Documento(
        id: widget.documento.id,
        expedienteId: widget.documento.expedienteId,
