...
class EditarCertificacionScreen extends ConsumerStatefulWidget {
  const EditarCertificacionScreen({
    super.key,
    required this.certificacion,
  });

  final Certificacion certificacion;

  @override
  ConsumerState<EditarCertificacionScreen> createState() =>
      _EditarCertificacionScreenState();
}

class _EditarCertificacionScreenState
    extends ConsumerState<EditarCertificacionScreen> {
  final _formKey = GlobalKey<FormState>();
  final _fechaController = TextEditingController();
  final _codigoController = TextEditingController();
  final _descripcionController = TextEditingController();
  final _baseImponibleController = TextEditingController();
  final _ivaPorcentajeController = TextEditingController();
  final _observacionesController = TextEditingController();

  late DateTime _fechaSeleccionada;
  late CertificacionEstado _estadoSeleccionado;

  @override
  void initState() {
    super.initState();
    _fechaSeleccionada = widget.certificacion.fecha;
    _estadoSeleccionado = widget.certificacion.estado;
    _fechaController.text = _formatearFecha(_fechaSeleccionada);
    _codigoController.text = widget.certificacion.codigo;
    _descripcionController.text = widget.certificacion.descripcion;
    _baseImponibleController.text = widget.certificacion.baseImponible.toString();
    _ivaPorcentajeController.text = widget.certificacion.ivaPorcentaje.toString();
    _observacionesController.text = widget.certificacion.observaciones ?? '';
  }
  ...
  Future<void> _guardarCertificacion() async {
    ...
    await repository.actualizarCertificacion(
      Certificacion(
        id: widget.certificacion.id,
        expedienteId: widget.certificacion.expedienteId,
        presupuestoId: widget.certificacion.presupuestoId,
            ...
            child: ListView(
              children: [
                AppSection(
                  ...
                  subtitle:
                      'Modifica la información de la certificación y guarda los cambios.',
                  child: Column(
