...
**PROD-3 — técnicamente preparado y verificado:** configuración fiscal explícita por tenant, ejercicio y circuito; series personalizadas, secuencias transaccionales, bloqueo tras primer uso y auditoría local. Schema 34. Análisis sin incidencias, 22 pruebas nuevas y suite completa de 388 pruebas superadas; compilación Windows debug en copia aislada idéntica y revisión de diff sin errores. PROD-1 y PROD-2 publicados y cerrados; aceptación manual de PROD-2 superada según confirmación del usuario. PROD-3 pendiente de aceptación manual solo en DEV; sin datos reales, sin push, PROD-4 y Fase 5 no iniciados. Modelo, límites y procedimiento en [PROD3_ARRANQUE_FISCAL.md](PROD3_ARRANQUE_FISCAL.md).
