...
**PROD-5 — corrección de originales vacíos verificada (2026-09-09):** rechazo de fuentes de cero bytes y lecturas incompletas/inestables, copia temporal validada y publicación completa antes de Drift. Los vacíos anteriores se conservan y se muestran como «Archivo vacío / revisar». Recrear la misma ruta con A/B no falla en la versión inicial; se ha reproducido su aceptación silenciosa de cero bytes, sin atribuir a OneDrive un origen no demostrado. Schema 36 sin migración. 10 pruebas nuevas, 71 de documentos/backup/restore y 449 en la suite completa superadas; analyze limpio, formato propio y diff sin errores; Windows debug aislado con 362 archivos relevantes idénticos. Pendiente repetir solo la aceptación A/B/vacío indicada en [el procedimiento](PROD5_DOCUMENTOS_BACKUP.md). Pruebas manuales y Producción intactas; sin push, PROD-6 ni Fase 5.
