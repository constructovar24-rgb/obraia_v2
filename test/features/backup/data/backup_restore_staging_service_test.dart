...
void main() {
  ...
  test(
    ...
    () async {
      ...
      expect(prepared.manifest.schemaVersion, 32);
      expect(prepared.preparedSchemaVersion, 32);
      ...
      try {
        expect(database.userVersion, 32);
        expect(
  ...
  test('migra una copia v22 a 27 conservando datos e importes', () async {
    ...
    try {
      ...
      expect(migratedDatabase.userVersion, 32);
  ...
  test('rechaza una copia con una tabla obligatoria ausente', () async {
    ...
    await expectLater(
      service.prepare(backupPath: backup.path, currentSchemaVersion: 32),
